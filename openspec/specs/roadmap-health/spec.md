...
Compute and surface health status for roadmap initiatives by comparing task completion against elapsed timeline, exposed in the daily note and via the MCP server.
