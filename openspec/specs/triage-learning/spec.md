...
Learn the user's Kanban triage habits from observed column assignments and surface confident column suggestions for untagged tasks, with patterns that decay over time.
